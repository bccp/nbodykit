...
def test_fftpower(comm):
    ...
    # zeldovich particles
    source = Source.ZeldovichParticles(cosmo, nbar=3e-6, redshift=0.55, BoxSize=1380., Nmesh=8, rsd='z', seed=42)
    ...
    with TaskManager(cpus_per_task, debug=True) as tm:
        ...
        try:
            for seed in tm.iterate([0, 1, 2]):
                ...
                # zeldovich particles
                source = Source.ZeldovichParticles(cosmo, nbar=3e-6, redshift=0.55, BoxSize=1380., Nmesh=8, rsd='z', seed=seed)

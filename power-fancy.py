...
parser = ArgumentParser("Fancy Parallel Power Spectrum Calculator",
        description=
...
def dot(pm, c1, c2):
    r"""
        Convolve two k space fields with a Particle Mesh object. 
        This is effectively multipling two fields in real space. 

        :math:`c_3 = \int c_1(k) c_2(q - k) d k`. What is really done?
        ...
        Returns
        -------
        None :  The convolution is stored in pm.complex[:].

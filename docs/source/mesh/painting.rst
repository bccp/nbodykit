...
object on to a mesh and how users can customize this procedure.
...
weighted counterpart via :math:`n'(\vx) = W(\vx) n(\vx)`.
...
column representing mass, and painting multiple species

...
in the :mod:`nbodykit.core` module. These classes serve as
...
`registry`, which stores all plugins of that type that have been successfully
loaded by the main nbodykit code.

1. **Algorithm**

    - **location**: :class:`nbodykit.core.Algorithm`
    - **registry**: :data:`nbodykit.algorithms`
...
2. **DataSource**
    ...
    - **location**: :class:`nbodykit.core.DataSource`
    - **registry**: :data:`nbodykit.datasources`
    - **description**: the mount point for plugins that refer to the reading of input data files

3. **Painter**

    - **location**: :class:`nbodykit.core.Painter`
    - **registry**: :data:`nbodykit.painters`
...
4. **Transfer**
    ...
    - **location**: :class:`nbodykit.core.Transfer`
    - **registry**: :data:`nbodykit.transfers`

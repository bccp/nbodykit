...
An nbodykit :class:`~nbodykit.core.algorithms.Algorithm` can be run using the `nbkit.py`_
...
will print the help message for the :class:`FFTPower <nbodykit.core.algorithms.PeriodicBox.FFTPowerAlgorithm>`
...
:class:`FFTPower <nbodykit.core.algorithms.PeriodicBox.FFTPowerAlgorithm>` algorithm, which
...
:class:`FastPM <nbodykit.core.datasource.FastPM.FastPMDataSource>` DataSource and
:class:`FOFGroups <nbodykit.core.datasource.FOFGroups.FOFDataSource>` DataSource classes
...
representation is :func:`~nbodykit.plugins.PluginBase.from_config`. This function
...
for the `field.DataSource` parameter, which will be loaded into a :class:`FastPM <nbodykit.core.datasource.FastPM.FastPMDataSource>` DataSource:
...
the :class:`FOFGroups <nbodykit.core.datasource.FOFGroups.FOFDataSource>` DataSource:
